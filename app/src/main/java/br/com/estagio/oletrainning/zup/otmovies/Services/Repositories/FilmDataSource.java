...
public class FilmDataSource extends PageKeyedDataSource<Integer, FilmResponse> {
    ...
    private MutableLiveData<Boolean> isLoadingPaginationControl = new MutableLiveData<>();

    public MutableLiveData<Boolean> getIsLoadingPaginationControl() {
        return isLoadingPaginationControl;
    }
